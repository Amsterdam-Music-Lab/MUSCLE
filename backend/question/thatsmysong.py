...
THATS_MY_SONG_QUESTIONS = [
    frequency_question("VB_01", _("I can sing or play a song from memory.")),
    frequency_question("VB_02", _("I can tell when people sing or play out of time with the beat of music.")),
    frequency_question("VB_03", _("I can recognize a piece of music after hearing just a few notes.")),
    ...
    frequency_question("VB_09", _("I am able to hit the right notes when I sing along with a recording.")),
    frequency_question("VB_10", _("I have a piece of music stuck on repeat in my head.")),
    frequency_question("VB_11", _("Music makes me dance.")),
    agreement_question("VB_12", _("I can tap in time with a musical beat.")),
    agreement_question("VB_13", _("I have never been complimented for my talents as a musical performer.")),
    agreement_question("VB_14", _("When I feel anxious, listening to music helps me see things in a more positive light.")),
    agreement_question("VB_15", _("Making music helps me to socially connect with others."))
]

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, max_length=64)),
                ('process_csv', models.BooleanField(default=False, help_text='Warning: Processing a live playlist may affect the result data')),
                ('csv', models.TextField(blank=True, help_text='CSV Format: artist_name [string],        song_name [string],start_position [float],duration [float],        "path/filename.mp3" [string], restricted_to_nl [int 0=False 1=True], tag_id [int], group_id [int]')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('playlist', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='experiment.playlist')),
            ],
        ),
        migrations.CreateModel(
            name='Section',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('json_data', models.TextField(blank=True)),
                ('section', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='experiment.section')),
        ...
        migrations.AddIndex(
            model_name='profile',
            index=models.Index(fields=['participant', 'answer'], name='experiment__partici_969242_idx'),
        ),
        migrations.AddIndex(
            model_name='profile',
            index=models.Index(fields=['session_id', 'answer'], name='experiment__session_b36855_idx'),
        ),
    ]

# Generated by Django 4.2.16 on 2024-12-13 12:47
...
class Migration(migrations.Migration):
    ...
    def unset_to_english(apps, schema_editor):
        ...
        for etc in ExperimentTranslatedContent.objects.all():
            if etc.language == "":
                try:
                    etc.language = "en"
                except:
                    etc.delete()
        for btc in BlockTranslatedContent.objects.all():
            if btc.language == "":
                try:
                    btc.language = "en"
                except:
    ...
    operations = [
        ...
        migrations.RunPython(unset_to_english, reverse_code=migrations.RunPython.noop),

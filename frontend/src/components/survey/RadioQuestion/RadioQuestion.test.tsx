...
describe("Radios", () => {
  ...
  it.skip("throws an error when no choices are provided", () => {
    const invalidQuestion = { ...mockQuestion, choices: {} };
    expect(() =>
      render(<Radios question={invalidQuestion} value="" onChange={() => {}} />)
  ...
  it.skip("marks the correct option as checked", () => {
  ...
  it.skip("applies correct classes to radio options", () => {
    render(<Radios question={mockQuestion} value="2" onChange={() => {}} />);
    const options = screen.getAllByRole("radio");
  ...
  it.skip("sets correct tabIndex on radio options", () => {
    render(<Radios question={mockQuestion} value="" onChange={() => {}} />);
    const options = screen.getAllByRole("radio");

...
import { CupType, ScoreBadge } from "@/components/modules";
import { ParticipantLink } from "@/components/modules";
...
export default function ProfileView({
    ...
    return (
        <>
            ...
            {scores && (
                <div className={styles.scroller} style={{ "--num-results": scores.length }}>

...
describe("TextRange Component", () => {
  ...
  it("renders correctly with empty value", () => {
    render(<TextRange question={mockQuestion} value="" onChange={() => {}} />);
  ...
  it("renders correctly with a min, max and current value", () => {
    render(<TextRange question={mockQuestion} value="3" onChange={() => {}} />);
  ...
  it("renders RangeTitle with correct props", () => {
    render(<TextRange question={mockQuestion} value="2" onChange={() => {}} />);
